...
class Device {
 ...
 public:
  ...
  Device(const Device& other): type(other.type), index(other.index) {}
...
class SymExpr {
 ...
 public:
  ...
  SymExpr& operator=(SymExpr&&) = default;
  SymExpr(const SymExpr& other): expr_str(other.expr_str), hint(other.hint) {}
  SymExpr& operator=(const SymExpr& other) = default;
...
class TensorMeta {
 ...
 public:
  ...
  TensorMeta& operator=(TensorMeta&&) = default;
  TensorMeta(const TensorMeta& other): dtype(other.dtype), sizes(other.sizes), requires_grad(other.requires_grad), device(other.device), strides(other.strides), storage_offset(other.storage_offset), layout(other.layout) {}
...
class TensorArgument {
 ...
 public:
  TensorArgument() = default;
  TensorArgument(TensorArgument&&) = default;
  TensorArgument& operator=(TensorArgument&&) = default;
  TensorArgument(const TensorArgument& other): name(other.name) {}
  TensorArgument& operator=(const TensorArgument& other) = default;
...
class TokenArgument {
 ...
 public:
  TokenArgument() = default;
  TokenArgument(TokenArgument&&) = default;
  TokenArgument& operator=(TokenArgument&&) = default;
  TokenArgument(const TokenArgument& other): name(other.name) {}
  TokenArgument& operator=(const TokenArgument& other) = default;
...
class GraphArgument {
 ...
 public:
  ...
  GraphArgument(GraphArgument&&) = default;
  GraphArgument& operator=(GraphArgument&&) = default;
  GraphArgument(const GraphArgument& other): name(other.name), graph(std::make_unique<Graph>(*other.graph)) {}
  GraphArgument& operator=(const GraphArgument& other) {
    name = other.name;
    graph = std::make_unique<Graph>(*other.graph);
    return *this;
  }
  ...
  const std::unique_ptr<Graph>& get_graph() const {
    return graph;
  }
...
class CustomObjArgument {
 ...
 public:
  CustomObjArgument() = default;
  CustomObjArgument(CustomObjArgument&&) = default;
  CustomObjArgument& operator=(CustomObjArgument&&) = default;
  CustomObjArgument(const CustomObjArgument& other): name(other.name), class_fqn(other.class_fqn) {}
  CustomObjArgument& operator=(const CustomObjArgument& other) = default;
...
class NamedArgument {
 ...
 public:
  ...
  NamedArgument& operator=(NamedArgument&&) = default;
  NamedArgument(const NamedArgument& other): name(other.name), arg(other.arg) {}
  NamedArgument& operator=(const NamedArgument& other) = default;
...
class Node {
 ...
 public:
  ...
  Node(const Node& other): target(other.target), inputs(other.inputs), outputs(other.outputs), metadata(other.metadata) {}
...
class Graph {
 ...
 public:
  ...
  Graph(const Graph& other): inputs(other.inputs), outputs(other.outputs), nodes(other.nodes), tensor_values(other.tensor_values), sym_int_values(other.sym_int_values), sym_bool_values(other.sym_bool_values), is_single_tensor_return(other.is_single_tensor_return), custom_obj_values(other.custom_obj_values) {}
...
class UserInputSpec {
 ...
 public:
  ...
  UserInputSpec(UserInputSpec&&) = default;
  UserInputSpec& operator=(UserInputSpec&&) = default;
  UserInputSpec(const UserInputSpec& other): arg(other.arg) {}
  UserInputSpec& operator=(const UserInputSpec& other) = default;
...
class ConstantInputSpec {
 ...
 public:
  ConstantInputSpec() = default;
  ConstantInputSpec(ConstantInputSpec&&) = default;
  ConstantInputSpec& operator=(ConstantInputSpec&&) = default;
  ConstantInputSpec(const ConstantInputSpec& other): name(other.name), value(other.value) {}
  ConstantInputSpec& operator=(const ConstantInputSpec& other) = default;
...
class InputToParameterSpec {
 ...
 public:
  InputToParameterSpec() = default;
  InputToParameterSpec(InputToParameterSpec&&) = default;
  InputToParameterSpec& operator=(InputToParameterSpec&&) = default;
  InputToParameterSpec(const InputToParameterSpec& other): arg(other.arg), parameter_name(other.parameter_name) {}
  InputToParameterSpec& operator=(const InputToParameterSpec& other) = default;
...
class InputToBufferSpec {
 ...
 public:
  InputToBufferSpec() = default;
  InputToBufferSpec(InputToBufferSpec&&) = default;
  InputToBufferSpec& operator=(InputToBufferSpec&&) = default;
  InputToBufferSpec(const InputToBufferSpec& other): arg(other.arg), buffer_name(other.buffer_name), persistent(other.persistent) {}
  InputToBufferSpec& operator=(const InputToBufferSpec& other) = default;
...
class InputToTensorConstantSpec {
 ...
 public:
  InputToTensorConstantSpec() = default;
  InputToTensorConstantSpec(InputToTensorConstantSpec&&) = default;
  InputToTensorConstantSpec& operator=(InputToTensorConstantSpec&&) = default;
  InputToTensorConstantSpec(const InputToTensorConstantSpec& other): arg(other.arg), tensor_constant_name(other.tensor_constant_name) {}
  InputToTensorConstantSpec& operator=(const InputToTensorConstantSpec& other) = default;
...
class InputToCustomObjSpec {
 ...
 public:
  InputToCustomObjSpec() = default;
  InputToCustomObjSpec(InputToCustomObjSpec&&) = default;
  InputToCustomObjSpec& operator=(InputToCustomObjSpec&&) = default;
  InputToCustomObjSpec(const InputToCustomObjSpec& other): arg(other.arg), custom_obj_name(other.custom_obj_name) {}
  InputToCustomObjSpec& operator=(const InputToCustomObjSpec& other) = default;
...
class InputTokenSpec {
 ...
 public:
  InputTokenSpec() = default;
  InputTokenSpec(InputTokenSpec&&) = default;
  InputTokenSpec& operator=(InputTokenSpec&&) = default;
  InputTokenSpec(const InputTokenSpec& other): arg(other.arg) {}
  InputTokenSpec& operator=(const InputTokenSpec& other) = default;
...
class UserOutputSpec {
 ...
 public:
  UserOutputSpec() = default;
  UserOutputSpec(UserOutputSpec&&) = default;
  UserOutputSpec& operator=(UserOutputSpec&&) = default;
  UserOutputSpec(const UserOutputSpec& other): arg(other.arg) {}
  UserOutputSpec& operator=(const UserOutputSpec& other) = default;
...
class LossOutputSpec {
 ...
 public:
  LossOutputSpec() = default;
  LossOutputSpec(LossOutputSpec&&) = default;
  LossOutputSpec& operator=(LossOutputSpec&&) = default;
  LossOutputSpec(const LossOutputSpec& other): arg(other.arg) {}
  LossOutputSpec& operator=(const LossOutputSpec& other) = default;
...
class BufferMutationSpec {
 ...
 public:
  BufferMutationSpec() = default;
  BufferMutationSpec(BufferMutationSpec&&) = default;
  BufferMutationSpec& operator=(BufferMutationSpec&&) = default;
  BufferMutationSpec(const BufferMutationSpec& other): arg(other.arg), buffer_name(other.buffer_name) {}
  BufferMutationSpec& operator=(const BufferMutationSpec& other) = default;
...
class GradientToParameterSpec {
 ...
 public:
  GradientToParameterSpec() = default;
  GradientToParameterSpec(GradientToParameterSpec&&) = default;
  GradientToParameterSpec& operator=(GradientToParameterSpec&&) = default;
  GradientToParameterSpec(const GradientToParameterSpec& other): arg(other.arg), parameter_name(other.parameter_name) {}
  GradientToParameterSpec& operator=(const GradientToParameterSpec& other) = default;
...
class GradientToUserInputSpec {
 ...
 public:
  GradientToUserInputSpec() = default;
  GradientToUserInputSpec(GradientToUserInputSpec&&) = default;
  GradientToUserInputSpec& operator=(GradientToUserInputSpec&&) = default;
  GradientToUserInputSpec(const GradientToUserInputSpec& other): arg(other.arg), user_input_name(other.user_input_name) {}
  GradientToUserInputSpec& operator=(const GradientToUserInputSpec& other) = default;
...
class UserInputMutationSpec {
 ...
 public:
  UserInputMutationSpec() = default;
  UserInputMutationSpec(UserInputMutationSpec&&) = default;
  UserInputMutationSpec& operator=(UserInputMutationSpec&&) = default;
  UserInputMutationSpec(const UserInputMutationSpec& other): arg(other.arg), user_input_name(other.user_input_name) {}
  UserInputMutationSpec& operator=(const UserInputMutationSpec& other) = default;
...
class OutputTokenSpec {
 ...
 public:
  OutputTokenSpec() = default;
  OutputTokenSpec(OutputTokenSpec&&) = default;
  OutputTokenSpec& operator=(OutputTokenSpec&&) = default;
  OutputTokenSpec(const OutputTokenSpec& other): arg(other.arg) {}
  OutputTokenSpec& operator=(const OutputTokenSpec& other) = default;
...
class GraphSignature {
 ...
 public:
  ...
  GraphSignature(GraphSignature&&) = default;
  GraphSignature& operator=(GraphSignature&&) = default;
  GraphSignature(const GraphSignature& other): input_specs(other.input_specs), output_specs(other.output_specs) {}
  GraphSignature& operator=(const GraphSignature& other) = default;
...
class RangeConstraint {
 ...
 public:
  ...
  RangeConstraint(RangeConstraint&&) = default;
  RangeConstraint& operator=(RangeConstraint&&) = default;
  RangeConstraint(const RangeConstraint& other): min_val(other.min_val), max_val(other.max_val) {}
  RangeConstraint& operator=(const RangeConstraint& other) = default;
...
class ModuleCallSignature {
 ...
 public:
  ModuleCallSignature() = default;
  ModuleCallSignature(ModuleCallSignature&&) = default;
  ModuleCallSignature& operator=(ModuleCallSignature&&) = default;
  ModuleCallSignature(const ModuleCallSignature& other): inputs(other.inputs), outputs(other.outputs), in_spec(other.in_spec), out_spec(other.out_spec), forward_arg_names(other.forward_arg_names) {}
  ModuleCallSignature& operator=(const ModuleCallSignature& other) = default;
...
class ModuleCallEntry {
 ...
 public:
  ModuleCallEntry() = default;
  ModuleCallEntry(ModuleCallEntry&&) = default;
  ModuleCallEntry& operator=(ModuleCallEntry&&) = default;
  ModuleCallEntry(const ModuleCallEntry& other): fqn(other.fqn), signature(other.signature) {}
  ModuleCallEntry& operator=(const ModuleCallEntry& other) = default;
...
class GraphModule {
 ...
 public:
  ...
  GraphModule& operator=(GraphModule&&) = default;
  GraphModule(const GraphModule& other): graph(other.graph), signature(other.signature), module_call_graph(other.module_call_graph), metadata(other.metadata) {}
  GraphModule& operator=(const GraphModule& other) = default;
...
class SchemaVersion {
 ...
 public:
  ...
  SchemaVersion& operator=(SchemaVersion&&) = default;
  SchemaVersion(const SchemaVersion& other): major(other.major), minor(other.minor) {}
  SchemaVersion& operator=(const SchemaVersion& other) = default;
...
class ExportedProgram {
 ...
 public:
  ...
  ExportedProgram(ExportedProgram&&) = default;
  ExportedProgram& operator=(ExportedProgram&&) = default;
  ExportedProgram(const ExportedProgram& other): graph_module(other.graph_module), opset_version(other.opset_version), range_constraints(other.range_constraints), schema_version(other.schema_version), verifiers(other.verifiers), torch_version(other.torch_version) {}
  ExportedProgram& operator=(const ExportedProgram& other) = default;
...
inline void from_json(const nlohmann::json& nlohmann_json_j, GraphArgument& nlohmann_json_t) {
  ...
  nlohmann_json_t.name = nlohmann_json_j.value("name", nlohmann_json_default_obj.name);
  nlohmann_json_t.graph = std::make_unique<Graph>(nlohmann_json_j.value("graph", *nlohmann_json_default_obj.graph));
}
