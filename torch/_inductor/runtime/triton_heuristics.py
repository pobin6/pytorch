...
def end_graph(output_file):
    log.info(f"Entering end_graph, collected_calls={collected_calls}")
...
class DebugAutotuner(CachingAutotuner):
    def __init__(self, *args, regex_filter="", with_profiler=False, bandwidth_info=True, **kwargs):
